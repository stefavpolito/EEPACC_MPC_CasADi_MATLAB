...
%       V : struct containg all vehicle parameters
    ...
    V.p00        =      -2.528;                 % Coefficient p00                               (kg/s)
    V.p10        =     0.01173;                 % Coefficient p10 multiplied by w_ICE           (kg/s)/(rad/s)
    V.p01        =     0.01325;                 % Coefficient p01 multiplied by T_ICE           (kg/s)/(Nm)

        % Vehicle Efficiency Map Fitting (Poly23) - DAILY
        % val(v_act,T_wheel) = k00 + k10*v_act + k01*T_wheel + k11*v_act*T_wheel
    % Coefficients (with 95% confidence bounds):
    V.k00 =      0.6154;  % (0.5887, 0.642)
    V.k10 =     0.01082;  % (0.009806, 0.01184)
    V.k01 =   0.0001016;  % (4.973e-05, 0.0001534)
    V.k11 =   0.0001438;  % (0.0001421, 0.0001454)
    ...
    V.upSpd       = [15,25,30,40,55,70,85]./3.6;% Upshifting Threshold                          m/s
