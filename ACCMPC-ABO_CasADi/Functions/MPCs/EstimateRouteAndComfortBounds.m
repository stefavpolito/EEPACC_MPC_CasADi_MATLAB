function [slope_est, v_lim_max,v_stop_max,v_TL_max,v_curv_max,a_min_est,a_max_est,j_min_est,j_max_est,tau_est] = EstimateRouteAndComfortBounds(OPTsettings,MPCtype,s_est,v_est,t_0,N_hor)
...
%% Estimate the current gear based on estimate of vehcile speed
    ...
    for i = 1:N_hor
        [tau_est(i),~] = LUTgearshift(v_est(i));
    end
